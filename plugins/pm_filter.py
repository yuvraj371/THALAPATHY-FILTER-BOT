...
async def pm_text(bot, message):
    ...
    await message.reply_text(
       ...
       f"<a href=https://t.me/+xbjscan3sfo4YzA1>ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ</a> ᴏʀ ᴄʟɪᴄᴋ ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ 👇\n\n"
       f"नमस्कार {user} 😍,\n\n"
       f"आपको यहां पर movie 🍿 नहीं मिलेगी कृपया हमारे "
       f"<a href=https://t.me/+xbjscan3sfo4YzA1>ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ</a> में search 🔎 करें या "
