...
from info import CHANNELS, ADMINS, FIRST_CHANNEL and SECOND CHANNEL, LOG_CHANNEL, PICS, BATCH_FILE_CAPTION, CUSTOM_FILE_CAPTION, PROTECT_CONTENT, CHNL_LNK, CHNL2_LNK, GRP_LNK, REQST_CHANNEL, SUPPORT_CHAT_ID, SUPPORT_CHAT, MAX_B_TN, VERIFY, SHORTLINK_API, SHORTLINK_URL, TUTORIAL, IS_TUTORIAL, PREMIUM_USER
...
async def start(client, message):
    ...
    if FIRST_CHANNEL, SECOND CHANNEL and not await is_subscribed(client, message):
        try:if FIRST_CHANNEL, SECOND CHANNEL and not await is_subscribed(client, message):
    try:
