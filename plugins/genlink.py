...
async def gen_link_s(bot, message):
    ...
    link_message = await get_shortlink(f'https://telegram.me/{temp.U_NAME}?start={outstr}')
...
async def gen_link_batch(bot, message):
    ...
    if chat_id in FILE_STORE_CHANNEL:
        ...
        link_message = await get_shortlink(f'https://telegram.me/{temp.U_NAME}?start=DSTORE-{b_64}')
