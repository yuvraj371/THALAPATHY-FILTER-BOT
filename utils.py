...
from info import FIRST_CHANNEL, SECOND_CHANNEL, LONG_IMDB_DESCRIPTION, MAX_LIST_ELM, SHORTLINK_URL, SHORTLINK_API, IS_SHORTLINK, LOG_CHANNEL, TUTORIAL, GRP_LNK, CHNL_LNK, CUSTOM_FILE_CAPTION
...
async def is_subscribed(bot, query):
    try:
        user = await bot.get_chat_member(FIRST_CHANNEL and SECOND_CHANNEL, query.from_user.id)
