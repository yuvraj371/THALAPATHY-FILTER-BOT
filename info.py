...
URL = "http://181.214.152.133:49152".format(FQDN) if ON_HEROKU or NO_PORT else \
    "http://181.214.152.133:49152/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "http://181.214.152.133:49152/".format(FQDN)
else:
    URL = "http://181.214.152.133:49152/".format(FQDN)
