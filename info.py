...
URL = "http://srv31221116.ultasrv.net".format(FQDN) if ON_HEROKU or NO_PORT else \
    "http://srv31221116.ultasrv.net/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "http://srv31221116.ultasrv.net/".format(FQDN)
else:
    URL = "http://srv31221116.ultasrv.net/".format(FQDN)
