...
PICS = (environ.get('PICS', 'https://telegra.ph/file/8d441e2cef6d10319f65a.png')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://te.legra.ph/file/a27dc8fe434e6b846b0f8.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://t.me/Infinity_XBotz/5")
...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '5787509903 5460055223').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://krishna527062:yuvraj178@cluster0.bki9yaw.mongodb.net/?retryWrites=true&w=majority")
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'X2J9CxQZosMUyy4xxbuKB2gwKOM2')
...
CHNL2_LNK = environ.get('CHNL2_LNK', 'https://t.me/+-qfrHvP10ko1ZDM1')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001614888083 -1001969275445 -1001913949460 -1001909861937 -1001902993418 -1001649093201 -1001958847611 -1001916568951 -1001679660189 -1001814598711 -1001897536766 -1001573267043 -1001908195675 -1001977131258 -1001900505229 -1001797491673 -1001887599197 -1001927194649 -1001777556813 -1001983826465 -1001949002295 -1001901273126 -1001974640079 -1001941721185 -1001989565249 -1001643206551 -1001876153662 -1001938582138 -1001923849682')).split()]
...
FQDN = environ.get('FQDN', 'srv31221116.ultasrv.net:8000')
first_channel = environ.get('FIRST_CHANNEL', '-1001984741311')
second_channel = environ.get('SECOND_CHANNEL', '-1001992981386')
...
FQDN = str(getenv('FQDN', 'srv31221116.ultasrv.net:8000')) if not ON_HEROKU else APP_NAME + '.herokuapp.com'
